    ...
    <div class="py-12">
        <div class="w-11/12 mx-auto sm:px-6 lg:px-8 grid grid-cols-3 gap-2">
            <x-count-card
                ...
                subtitle="At-least 1 non-refunded purchase"
                content="{{ $payingCustomers }}"
            >
                @slot('icon')
            ...
            <x-count-card
                ...
                subtitle="Average net revenue per customer"
                color="red"
            ...
            <x-count-card
                ...
                subtitle="Customer with the most net revenue"
                color="red"
            >
                @slot('icon')
                    <svg class="h-8 w-8 text-white" viewBox="0 0 28 28" fill="none"
                ...
                @endslot
                @slot('content')
                    <span>{{ $highestSpender['name'] }}</span> with <span>${{ number_format($highestSpender['netRevenue']) }}</span>
                @endslot
            </x-count-card>
        </div>
        ...
        <div class="w-11/12 mx-auto sm:px-6 lg:px-8 mt-4">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-4 shadow">
                <div class="flex flex-col justify-between w-full mb-4">
                    <p class="text-2xl">Total Purchase and Refunds by Customer</p>
                    <p class="text-base text-gray-600">Total Purchase and Refunds by Customer</p>
                </div>
                <livewire:customer.purchase-and-refunds-table></livewire:customer.purchase-and-refunds-table>
            </div>
        </div>
    </div>
</x-app-layout>
